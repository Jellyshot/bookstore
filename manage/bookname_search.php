<?php
    ...
    <form name="sform" method="POST" action="./bookname_search.php">
        <input type="text" name="aut_search" id="cInput" placeholder="작가명을입력하세요">
...
?>      <tr>
        <td><input type="radio" name="aut_code" value="<?=$row['aut_code']?>" id="cInput"></td>
        <td><?=$row['aut_name']?></td>
        </tr>
<?php
        } 
?>
        ...
        <input type="submit" onclick="setValues()" value="선택하기" style="border:none; font-size:16px;">
        </form>
